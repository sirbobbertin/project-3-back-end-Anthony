...
public class ProductPojo {
	...
	//-------Type didn't match Entity, & SqL column in schema.sql
	...
	//--------Temporary Fix : For Discount table Joins, Images
	...
	//-----------James Fix ends here
	/*
	public ProductPojo(int productId, String productSku, String productName, double productCost, String productCategory,
